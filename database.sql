...
CREATE TABLE `servers` (
  ...
  `notes` text DEFAULT NULL,
  `allocated_ips` text DEFAULT NULL,
  `monthly_cost` decimal(10,2) DEFAULT 0.00,
  `datacenter` varchar(190) DEFAULT NULL,
  `account_limit` int(11) DEFAULT NULL,
  `status_url` varchar(255) DEFAULT NULL,
  `disabled` tinyint(1) DEFAULT 0,
  `ns1` varchar(190) DEFAULT NULL,
  `ns1_ip` varchar(45) DEFAULT NULL,
  `ns2` varchar(190) DEFAULT NULL,
  `ns2_ip` varchar(45) DEFAULT NULL,
  `ns3` varchar(190) DEFAULT NULL,
  `ns3_ip` varchar(45) DEFAULT NULL,
  `ns4` varchar(190) DEFAULT NULL,
  `ns4_ip` varchar(45) DEFAULT NULL,
  `ns5` varchar(190) DEFAULT NULL,
  `ns5_ip` varchar(45) DEFAULT NULL,
  `module` varchar(50) DEFAULT 'directadmin',
  `username` varchar(190) DEFAULT NULL,
  `password` varchar(190) DEFAULT NULL,
  `ssl` tinyint(1) DEFAULT 0,
  `port` int(11) DEFAULT 2222,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
