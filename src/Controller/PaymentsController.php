...
class PaymentsController
{
    ...
    public function index(): void
    {
        ...
        try {
            ...
            $sql = "SELECT p.*, c.title AS contract_title, cust.name AS customer_name
                    FROM payments p
    ...
    public function create(): void
    {
        ...
        try {
            ...
            $stmt = $pdo->prepare("INSERT INTO payments (contract_id, customer_id, contract_amount, amount, pay_date, paid_at, method, status, note, external_source, external_ref, created_at, updated_at)
                                   VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)");
    ...
    public function edit(): void
    {
        ...
        try {
            ...
            $stmt = $pdo->prepare("UPDATE payments SET contract_id=?, customer_id=?, contract_amount=?, amount=?, pay_date=?, paid_at=?, method=?, status=?, note=?, updated_at=? WHERE id=?");
            $now = date('Y-m-d H:i:s');
            $stmt->execute([
                $contract_id ?: null,
                $customer_id ?: null,
